        ...
        coordinates: {  // [longitude, latitude]
            ...
            validate: {
                validator: function(coords) {
                    ...
                    return (
                        latitude >= 29.5 && latitude <= 33.3 && // Israel latitude bounds
                        longitude >= 34.3 && longitude <= 35.9  // Israel longitude bounds
                    );
                },
                message: 'Coordinates must be within Israel\'s boundaries'
            }
        }
    }
}, {
...
recycleBinSchema.index({ location: '2dsphere' });
